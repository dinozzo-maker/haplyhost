...
const IT = {
  ...
  erroreCaricamento: 'Non riesco a caricare la guida in questo momento. Riprova tra poco.',
...
export const T: Record<Lingua, Record<ChiaveTesto, string>> = {
  ...
  en: {
    ...
    erroreCaricamento: "I can't load this guide right now. Please try again shortly.",
  ...
  fr: {
    ...
    erroreCaricamento: "Je ne peux pas charger ce guide pour le moment. Réessayez dans un instant.",
  ...
  de: {
    ...
    erroreCaricamento: 'Dieser Guide kann gerade nicht geladen werden. Bitte versuchen Sie es gleich noch einmal.',
  ...
  es: {
    ...
    erroreCaricamento: 'No puedo cargar esta guía ahora mismo. Inténtalo de nuevo en un momento.',
