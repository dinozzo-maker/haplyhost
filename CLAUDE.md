...
│   │                          Icona: `<GennarinoAvatar>` (16/09/2026, prova) con una regola dedicata `.g-fab-avatar` in
│   │                          index.css che lo fa riempire tutto il cerchio da 52px (la regola generica è 24px, per le icone)
...
│       │                          ambra piena — contrasto migliore). Esteso a TUTTE le pagine del pannello (16/09/2026,
...
│       │                          le classi per esteso, non `<Pulsante>` più un override
...
│       │                          su `strutture` (RLS owner). Prima pagina vestita con `./ui.tsx` (14/09/2026, poi esteso a
│       │                          tutte le altre — vedi sopra). Blocco "Aspetto della guida": 5 preset colore (`accento`) + foto
